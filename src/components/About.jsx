  ...
  return(
    <Section>
      ...
      <Content>
        ...
        <p>Я увлекаюсь программированием с лета 2020 года, и за это время успел попробовать несколько направлений, таких как <strong>разработка игр</strong>, <strong>Back-end</strong> разработка, разработка на <strong>Python</strong> и <strong>Front-end</strong> разработка. За полтора года изучения программирования я выучил языки программирования <strong>Python</strong>, <strong>JavaScript</strong>, <strong>HTML</strong> и <strong>CSS</strong>, а также фреймворк <strong>React JS</strong>.</p>
